...
function _Foundation_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', '_Foundation' ),
	) );
 ...
 */
function _Foundation_content_width() {
	$GLOBALS['content_width'] = apply_filters( '_Foundation_content_width', 640 );
}
add_action( 'after_setup_theme', '_Foundation_content_width', 0 );
...
function _Foundation_scripts() {
	...
	wp_enqueue_script( ' _Foundation-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( ' _Foundation-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
